const en = {
  ...
  carDetail: {
    ...
    consultation: {
      ...
      subtitle: "Our specialist will contact you within 24 hours",
      name: "Your name",
      email: "Email",
      phone: "Phone",
      ...
      successBody: "We will reach you shortly.",
      alreadyTitle: "Already submitted",
      alreadyBody:
        "You have already submitted a request for this model. Our specialist will contact you soon.",
      close: "Close",
      ...
      errors: {
        ...
        messageRequired: "Please describe your inquiry",
