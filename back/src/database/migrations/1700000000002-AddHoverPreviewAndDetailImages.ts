...
export class AddHoverPreviewAndDetailImages1700000000002
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_car_detail_images_car_id"`);
    await queryRunner.query(`DROP TABLE IF EXISTS "car_detail_images"`);
    await queryRunner.query(`ALTER TABLE "cars" DROP COLUMN IF EXISTS "hover_preview"`);
  }
}
